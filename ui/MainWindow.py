...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chooseModelCombo = QtWidgets.QComboBox(self.groupBox_2)
        self.chooseModelCombo.setGeometry(QtCore.QRect(250, 50, 141, 22))
        self.chooseModelCombo.setObjectName("chooseModelCombo")
        self.label_2 = QtWidgets.QLabel(self.groupBox_2)
        self.label_2.setGeometry(QtCore.QRect(30, 120, 111, 16))
        self.label_2.setObjectName("label_2")
        self.chooseZebraCombo = QtWidgets.QComboBox(self.groupBox_2)
        self.chooseZebraCombo.setGeometry(QtCore.QRect(250, 120, 141, 22))
        self.chooseZebraCombo.setObjectName("chooseZebraCombo")
        self.label_3 = QtWidgets.QLabel(self.groupBox_2)
        self.label_3.setGeometry(QtCore.QRect(30, 200, 111, 16))
        self.label_3.setObjectName("label_3")
        self.chooseVideoType = QtWidgets.QComboBox(self.groupBox_2)
        self.chooseVideoType.setGeometry(QtCore.QRect(250, 190, 141, 22))
